package com.example.authservice.auth.infrastructure.spring;
...
import com.example.authservice.auth.infrastructure.spring.security.auth.CustomUserAuthDetails;
