...
public class RoleAuthorizationAspect {
    ...
    @Before("within(@com.example.libraryapp.NEWinfrastructure.security.RoleAuthorization *) || @annotation(com.example.libraryapp.NEWinfrastructure.security.RoleAuthorization)")
