...
public class BookItemAvailableToBorrowNotification extends BookItemNotification {
    ...
    public BookItemAvailableToBorrowNotification(BookItemEvent event, MessageProviderPort msgProvider) {
        ...
        this.subject = msgProvider.getMessage(MessageKey.NOTIFICATION_BOOK_AVAILABLE_SUBJECT);
        this.content = msgProvider.getMessage(
                MessageKey.NOTIFICATION_BOOK_AVAILABLE_CONTENT, event.getBookTitle(), event.getBookItemId()
        );
    }
}
