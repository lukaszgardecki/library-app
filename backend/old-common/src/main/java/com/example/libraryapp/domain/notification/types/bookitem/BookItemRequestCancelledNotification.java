...
public class BookItemRequestCancelledNotification extends BookItemNotification {
    ...
    public BookItemRequestCancelledNotification(BookItemEvent event, MessageProviderPort msgProvider) {
        ...
        this.subject = new NotificationSubject(msgProvider.getMessage(MessageKey.NOTIFICATION_REQUEST_CANCELLED_SUBJECT));
        this.content = new NotificationContent(
                msgProvider.getMessage(
                        MessageKey.NOTIFICATION_REQUEST_CANCELLED_CONTENT,
