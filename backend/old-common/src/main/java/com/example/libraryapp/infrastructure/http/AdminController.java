...
class AdminController {
    ...
    public ResponseEntity<List<Integer>> countUserLoansPerMonth(@PathVariable Long id) {
        List<Integer> loansPerMonth = statisticsFacade.countUserLoansPerMonth(new UserId(id));
